...
void main() {
  ...
  testWidgets('canceling an edit preserves the original title', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('editing a completed task preserves state and ordering', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('deletion remains permanent after the Undo snackbar expires', (
    WidgetTester tester,
  ) async {
